...
export default function Residents() {
  return (
    <>
      <div className="grid grid-cols-2 gap-16 sm:flex-col items-center my-16 justify-between sm:text-center">
        <img
          alt=""
          src="./illustrations/hands out of laptop.svg"
          className="cols-span-1 justify-self-center lg:h-[14rem] md:h-[10rem] sm:hidden"
        />
