...
const clients = [
  ...
  {
    name: "Timeless Finance", logo: "timelessfi.svg", website: "https://timelessfi.com/",
  },
  { name: "Manifold Finance", logo: "manifold.svg", website: "https://manifoldfinance.com/" },
  ...
  { name: "Asymmetry", logo: "asymetry.svg", website: "https://www.asymmetry.finance/" },
  ...
  { name: "Olumpus DAO", logo: "olympus.svg", website: "https://www.olympusdao.finance/" },
  {
    name: "Nouns DAO", logo: "nouns.svg", website: "https://nouns.wtf/",
  },
...
function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[100vh] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl">
      ...
      <OrbitingCircles
        className={"size-[45px] border-none bg-transparent hover:cursor-pointer"}
        duration={60}
        delay={10 * i}
        radius={140}
        >
